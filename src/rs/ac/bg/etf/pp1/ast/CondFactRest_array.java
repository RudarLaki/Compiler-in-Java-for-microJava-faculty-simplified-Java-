...
public class CondFactRest_array extends CondFactRest {

    private CondFact CondFact;
    private CondFactRest CondFactRest;

    public CondFactRest_array (CondFact CondFact, CondFactRest CondFactRest) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactRest_array(\n");
