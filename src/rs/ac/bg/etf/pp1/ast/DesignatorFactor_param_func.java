...
public class DesignatorFactor_param_func extends PartFactor {

    private Designator Designator;
    private ActParsList ActParsList;

    public DesignatorFactor_param_func (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorFactor_param_func(\n");
