...
public class ParamFactor_non_empty extends Factor {

    private Designator Designator;
    private ActParsList ActParsList;

    public ParamFactor_non_empty (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ParamFactor_non_empty(\n");
